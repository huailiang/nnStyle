...
#define DefineEncoderConv(id, input, output, depth1, depth2, stride, idx, pidx)	\
	...
	{	\
		...
		{	\
			int seq[9];	\
			StdOrderSeq(id.x*stride, id.y*stride, i, output, depth1, seq);	\
			float3x3 sample = float3x3(encoder_conv##pidx##[seq[0]], encoder_conv##pidx##[seq[1]], encoder_conv##pidx##[seq[2]], \
